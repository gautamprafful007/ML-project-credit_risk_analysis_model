...
def predict(age, income, loan_amount, loan_tenure_months, average_dpd_per_delinquency,
            delinquent_ratio, credit_utilization_ratio, num_open_accounts,
            residence_type, loan_purpose, loan_type):
    
    # Prepare input data
    input_df=prepare_input(age, income, loan_amount, loan_tenure_months, average_dpd_per_delinquency,
                             delinquent_ratio, credit_utilization_ratio, num_open_accounts, residence_type,
                             loan_purpose, loan_type)
